...
public class MethodPut extends RestMethod {
	private static String TAG = MethodPut.class.getSimpleName();
	
	public MethodPut(Method method, String url, Map<String, List<String>> headers, String body) {
