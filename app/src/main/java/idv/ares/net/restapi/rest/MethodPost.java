...
class MethodPost extends RestMethod {
	private static String TAG = MethodPost.class.getSimpleName();
	
	public MethodPost(Method method, String url, Map<String, List<String>> headers, String body) {
