...
class MethodDelete extends RestMethod {
	private static String TAG = MethodDelete.class.getSimpleName();
	
	MethodDelete(Method method, String url, Map<String, List<String>> headers, String body) {
